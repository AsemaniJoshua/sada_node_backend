...
import publicNotificationRouter from "./routers/public/notifications.js";
...
// Middleware to parse JSON data from the request body (increased limit to support rich-text editor base64 uploads)
...
app.use('/api/notifications', publicNotificationRouter);
// Admin routes
